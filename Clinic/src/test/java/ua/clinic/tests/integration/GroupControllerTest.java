...
public class GroupControllerTest {
    ...
    public void test_newGroup() throws Exception{
        ...
        groupAPI.group_name = "test_group_name";
        groupAPI.description = "test_description";

        ObjectMapper om = new ObjectMapper();
        String content = om.writeValueAsString(groupAPI);

        MvcResult result = mockMvc.perform(post("/groupAPI/new")
